...
void MPFA_loop_functions::PostExperiment() {
	...
	ostringstream varySpeed;
        ...
        string header = "./results/"+type+"_Ideal_MPFA_Dynamic_transport_" + backtrack +"_n"+num_nests.str()+"_r"+num_robots.str()+"_tag"+num_tag.str()+"_"+arena_width.str()+"by"+arena_width.str()+"_vary_speed_"+ varySpeed.str()+"_quard_arena_" + quardArena.str() +"_";
